...
export default function Producto({ producto, relacionados, seo }) {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
                    ...
                    <div className="flex flex-col">
                        ...
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-medium text-sm px-6 py-3 rounded-xl transition-colors w-full sm:w-auto"
                        >
                            {/* Ícono WhatsApp */}
